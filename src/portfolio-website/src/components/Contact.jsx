        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4 mb-8">
                {socialLinks.map((link, index) => (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    whileHover={{ x: 10 }}
                    className="flex items-center gap-4 bg-white rounded-lg p-4 hover:border-primary/50 transition-all duration-300 group border border-gray-100 shadow-sm hover:shadow-md"
                  >
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="bg-white rounded-xl p-8 flex flex-col items-center justify-center border border-gray-100 shadow-sm"
            >
              {/* CV Icon */}
              <div className="mb-6">
