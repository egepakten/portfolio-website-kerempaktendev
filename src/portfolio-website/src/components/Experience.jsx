            ...
            <div className="space-y-6">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <div
                    className={`bg-card rounded-xl p-6 cursor-pointer transition-all duration-300 shadow-sm hover:shadow-md ${
                      expandedIndex === index
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-muted-foreground text-sm font-mono bg-secondary px-3 py-1 rounded-full">
                        {exp.period}
                      </span>
                    </div>
                          ...
                          <div className="border-t border-border pt-4 mt-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {exp.technologies.map((tech, i) => (
                                <span
                                  key={i}
                                  className="px-3 py-1.5 bg-primary/20 text-primary rounded-lg text-sm font-medium hover:bg-primary/30 transition-colors border border-primary/30"
                                >
                                  {tech}
                                </span>
                              ))}
