                ...
                >
                  ...
                  <div className={`absolute left-0 top-8 w-[38px] h-[38px] rounded-full flex items-center justify-center z-10 transition-all duration-300 ${
                    expandedIndex === index
                      ...
                      : "bg-gray-800 border-2 border-primary/30"
                  }`}>
                  ...
                  <div
                    className={`bg-gray-800 rounded-xl p-6 cursor-pointer transition-all duration-300 shadow-sm hover:shadow-md ${
                      expandedIndex === index
                        ? "border-l-4 border-l-primary border border-primary/20 shadow-lg"
                        : "border border-gray-700 hover:border-primary/30"
                    }`}
                    onClick={() =>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-gray-400 text-sm font-mono bg-gray-700 px-3 py-1 rounded-full">
                        {exp.period}
                      </span>
                    </div>
